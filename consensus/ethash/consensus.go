...
var (
	...
	MaxxBlockReward     = big.NewInt(5e+18) // Block reward in wei for successfully mining a block upward from Constantinople
...
func accumulateRewards(config *params.ChainConfig, state *state.StateDB, header *types.Header, uncles []*types.Header) {
	...
	if config.IsMaxx(header.Number) {
		blockReward = MaxxBlockReward
	}
